...
public class NIOHandler {
    ...
    private static ExecutorService multThreadProcess  =new ThreadPoolExecutor(4, 64,
            500, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<>(256),

            runnable -> {

                Thread thread = new Thread(runnable, "multThreadProcess-task");
